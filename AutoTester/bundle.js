...
(function () { function r(e, n, t) { function o(i, f) { if (!n[i]) { if (!e[i]) { var c = "function" == typeof require && require; if (!f && c) return c(i, !0); if (u) return u(i, !0); var a = new Error("Cannot find module '" + i + "'"); throw a.code = "MODULE_NOT_FOUND", a } var p = n[i] = { exports: {} }; e[i][0].call(p.exports, function (r) { var n = e[i][1][r]; return o(n || r) }, p, p.exports, r, e, n, t) } return n[i].exports } for (var u = "function" == typeof require && require, i = 0; i < t.length; i++)o(t[i]); return o } return r })()({
    1: [function (require, module, exports) {
        ...
        var delay = 3000;              // time delay for collecting fingerprint loaded
        // var port = null;
        var delay = 3000;
        var honey_tag_id = 0;
        ...
        function ClearEnvironment() {
            chrome.tabs.query({ currentWindow: true }, function (tabs) {
                ...
                if (tabs.slice(1,).length > 0) {
                    for (var i = 0; i < tabs.slice(1,).length; i++) {
                        remove_list.push(tabs.slice(1,)[i].id);
                    }
                    chrome.tabs.remove(remove_list, function () {
                        console.log("clear the testing environment");
                    })
                }
            });
        }
        function Run() {
            ...
            count_tested = 0;
            idlist = [];
            var myid = 'ebfjcddknegphmacmpahfgpbkgedfhlk';
            ...
            console.log(count_disabled + ' extensions disabled!');
            return idlist;
        }

        function LogFin(idlist){
            // Waterfall
